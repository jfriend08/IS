...
\begin{figure}[H]
\centering
  \subfigure{\label{fig1:a}\includegraphics[width=75mm]{../fig/UpdateTest_num_singleII_Alpha100000_err.png}}

  \subfigure{\label{fig1:a}\includegraphics[width=75mm]{../fig/boundary_sigma.png}}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=075mm]{../fig/Ana_vs_num_relativeErr_Q.png}
...
\begin{figure}[H]
\centering
  \subfigure{\label{fig1:a}\includegraphics[width=75mm]{../fig/OnlyOne_Alpha5_0_epch394_err.png}}
  \subfigure{\label{fig1:a}\includegraphics[width=75mm]{../fig/gm_Q.png}}
...
\begin{figure}[H]
\centering
  \subfigure{\label{fig1:a}\includegraphics[width=75mm]{../fig/L_Q.png}}
  \subfigure{\label{fig1:a}\includegraphics[width=75mm]{../fig/L_Boundary.png}}
